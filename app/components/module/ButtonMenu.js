...
function ButtonMenu() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-[#60606033] backdrop-blur-xl border-[1px] border-gray-500 flex justify-center items-center rounded-[20px] z-30 w-[90%] max-w-[344px] h-[64px]">
